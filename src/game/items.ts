...
import { ARENA_DIFFICULTY_META, ITEM_RARITIES, ITEM_TYPES, ITEM_TYPE_LABELS, RARITY_META } from './enums';
import { percentRoll, pick, randomId, randomInt, shuffled } from './rng';
import type {
...
export function generateItem(
    ...
    const type = forcedType ?? pick(ITEM_TYPES);
    const base = pick(ITEM_BASES[type]);
