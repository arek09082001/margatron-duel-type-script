...
/**
 * The ten lands, in the order a character walks them.
 *
 * Every map image under `public/game-assets/maps` is generated by
 * `tools/town-art/build.py` from the layout in `tools/town-art/towns.py`, and
 * the click rectangles in `catalog.ts` come out of the same build. Change a
 * town's shape there, re-run the build, and copy the numbers across — do not
 * nudge coordinates here by hand.
 */
export const MAP_META: Record<number, MapMeta> = {
    1: { id: 1, name: 'Olszawa', image: 'maps/olszawa.png', levelMin: 1, levelMax: 10, requiredLevel: 1 },
    2: { id: 2, name: 'Rudzin', image: 'maps/rudzin.png', levelMin: 11, levelMax: 20, requiredLevel: 9 },
    3: {
        id: 3,
        name: 'Wielgrad',
        image: 'maps/wielgrad.png',
        levelMin: 21,
        levelMax: 30,
        requiredLevel: 20,
    },
    ...
    5: { id: 5, name: 'Sołwar', image: 'maps/solwar.png', levelMin: 41, levelMax: 50, requiredLevel: 40 },
    6: { id: 6, name: 'Nihrast', image: 'maps/nihrast.png', levelMin: 51, levelMax: 60, requiredLevel: 50 },
    7: { id: 7, name: 'Zhurmat', image: 'maps/zhurmat.png', levelMin: 61, levelMax: 70, requiredLevel: 60 },
    8: { id: 8, name: 'Grzmiel', image: 'maps/grzmiel.png', levelMin: 71, levelMax: 80, requiredLevel: 70 },
    9: { id: 9, name: 'Ismeria', image: 'maps/ismeria.png', levelMin: 81, levelMax: 90, requiredLevel: 80 },
    10: { id: 10, name: 'Zoryan', image: 'maps/zoryan.png', levelMin: 91, levelMax: 100, requiredLevel: 90 },
};
